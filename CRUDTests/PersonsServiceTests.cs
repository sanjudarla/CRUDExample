...
namespace CRUDTests
{
    public class PersonsServiceTest
    {
        ...
        public PersonsServiceTest(ITestOutputHelper testOutputHelper)
        {
            ...
            var deleterloggerMock = new Mock<ILogger<PersonsDeleteService>>();
            ...
            _countriesGetterService = new CountriesGetterService(null);

            _personsDeleterService = new PersonsDeleteService(_personsRepository, deleterloggerMock.Object, diagnosticContextMock.Object);
